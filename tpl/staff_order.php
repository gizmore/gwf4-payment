...
$status_text = $lang->lang('status_'.$status);
switch ($status)
{
...
//if ($order->isCreated())
//{
//	echo GWF_Button::generic($lang->lang('btn_mark_paid'), $tVars['href_paid']);	
//}
//echo '</div>'.PHP_EOL;
